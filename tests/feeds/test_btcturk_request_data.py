...
def test_btcturk_private_headers_include_signature(monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr(
        "bt_api_btcturk.feeds.live_btcturk.request_base.time.time", lambda: 1700000000.0
    )
...
def test_btcturk_get_kline_builds_time_window(monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr("bt_api_btcturk.feeds.live_btcturk.spot._time.time", lambda: 1700000000)
