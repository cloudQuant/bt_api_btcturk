...
This package provides **BTCTurk exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BTCTURK** exchange.
...
```python
from bt_api_btcturk import BtcturkApi

# Initialize
feed = BtcturkApi(api_key="your_key", secret="your_secret")
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_btcturk |
| Issue Tracker | https://github.com/cloudQuant/bt_api_btcturk/issues |
...
```
bt_api_btcturk/
├── src/bt_api_btcturk/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_btcturk/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BTCTurk exchange plugin for bt_api**。它提供了与 **BTCTURK** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_btcturk |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_btcturk/issues) 反馈问题
